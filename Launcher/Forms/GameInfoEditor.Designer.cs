namespace launcherdotnet.Launcher.Forms
{
    partial class GameInfoEditor
    {
        ...
        private void InitializeComponent()
        {
            ...
            // modManagerIdLabel
            // 
            modManagerIdLabel.Anchor = AnchorStyles.Top | AnchorStyles.Bottom | AnchorStyles.Left;
            modManagerIdLabel.AutoSize = true;
            modManagerIdLabel.Location = new Point(6, 62);
            modManagerIdLabel.Margin = new Padding(6);
            modManagerIdLabel.Name = "modManagerIdLabel";
            modManagerIdLabel.Size = new Size(96, 17);
